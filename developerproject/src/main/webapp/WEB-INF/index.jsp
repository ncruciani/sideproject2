...
<body>
	<div class="whole">
		...
		<div class="first_page_container">
			...
			<div class="logins">
				<a href="/login" class="button" id="homebutton">Dev Login</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;      
				<a href="/login/organization" class="button" id="homebutton">Org
					Login</a>
			</div>
			...
			<div class="form_container">
				...
				<form:form action="/register" method="post" modelAttribute="newUser">
					...
					<div class="input">
						...
						<form:input path="lastName" type="text" id="last_name" required="true"/>
						<br>
					...
					<div class="input">
						...
						<form:input path="address" id="address"  required="true"/><br>
					...
					<div class="input">
						...
						<form:input type="text" id="city" path="city" required="true"/>
            ...
            <button class="button-49" role="button" value="Register" type="submit" style="margin-top:30px">Register</button>
			...
			<a href="/org">Need to Sign Up on Organization?</a>
